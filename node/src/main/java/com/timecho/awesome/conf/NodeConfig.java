...
public class NodeConfig {
  ...
  private ServerType cnodeServerType = ServerType.ASYNC;
  ...
  public ServerType getCnodeServerType() {
    return cnodeServerType;
  }

  public void setCnodeServerType(ServerType cnodeServerType) {
    this.cnodeServerType = cnodeServerType;
  }
