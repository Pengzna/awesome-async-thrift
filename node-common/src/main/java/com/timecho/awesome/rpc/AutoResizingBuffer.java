...
class AutoResizingBuffer {
  ...
  private byte[] array;
  private int bufTooLargeCounter = NodeConstant.MAX_BUFFER_OVERSIZE_TIME;
  ...
  public void resizeIfNecessary(int size) {
    ...
    if (currentCapacity < size) {
      ...
      bufTooLargeCounter = NodeConstant.MAX_BUFFER_OVERSIZE_TIME;
      logger.debug(
      ...
      && System.currentTimeMillis() - lastShrinkTime > NodeConstant.MIN_SHRINK_INTERVAL) {
