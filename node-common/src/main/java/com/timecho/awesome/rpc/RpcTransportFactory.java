...
public class RpcTransportFactory extends TTransportFactory {
  ...
  private static int thriftDefaultBufferSize = NodeConstant.THRIFT_DEFAULT_BUF_CAPACITY;
  private static int thriftMaxFrameSize = NodeConstant.THRIFT_FRAME_MAX_SIZE;
