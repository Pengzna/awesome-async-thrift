...
package com.timecho.awesome.concurrent.threadpool;

import com.timecho.awesome.concurrent.WrappedCallable;
import com.timecho.awesome.concurrent.WrappedRunnable;
...
public class WrappedSingleThreadExecutorService
  ...
  public WrappedSingleThreadExecutorService(ExecutorService service, String mbeanName) {
    ...
    this.mbeanName =
      String.format(
        "%s:%s=%s", this.getClass().getPackage(), NodeConstant.JMX_TYPE, mbeanName);
